...
holding 392 pair-rows (29 edge-restoring + 363 water-flag-only), each pair
...
This engine applies the whole layer in one pass:
  ...
  rescreen_gap         rescreen_gap_overlay_pairs.csv         +16 edges, +16 water rows
                                                              ...
                                                              per-row water_type)
  rescreen_water       rescreen_water_overlay_pairs.csv       water flags on 317 edges
                                                              (water-screen rebuild
                                                              b1-b6, per-row water_type)
  ==================== ====================================== ========================

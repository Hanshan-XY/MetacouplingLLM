...
| ADM1 (subnational) | First-level administrative regions | 3,374 regions, 8,458 shared-border pairs (8,054 under the default `moderate` coupling standard), 196 countries |
...
| ADM1 edge list (CSV) | 8,458 subnational shared-border pairs across 3,374 regions in 196 countries (World Bank Official Boundaries, 2026-05-14; see `data/PROVENANCE.md`) |

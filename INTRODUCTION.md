...
| ADM1 (subnational) | First-level administrative regions | 3,375 regions, 8,450 shared-border pairs (8,212 under the default `moderate` coupling standard), 196 countries |
...
| ADM1 edge list (CSV) | 8,450 subnational shared-border pairs across 3,375 regions in 196 countries (World Bank Official Boundaries, 2026-05-14; see `data/PROVENANCE.md`) |

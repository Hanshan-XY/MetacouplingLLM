...
| ADM1 (subnational) | First-level administrative regions | 3,373 regions, 8,381 shared-border pairs (8,235 under the default `moderate` coupling standard), 196 countries |

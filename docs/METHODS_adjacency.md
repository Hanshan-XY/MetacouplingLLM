...
ADM0** roll-ups, by source: 298 base bridge classification + 18 hydro-water
...
rows from ru1 (2026-07-21), lake-class rows from wu1 (2026-07-25) — correction history in `CHANGELOG.md`), and the two **rescreen overlays**
